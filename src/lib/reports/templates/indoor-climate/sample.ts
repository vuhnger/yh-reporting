...
const indoorClimateSampleData: IndoorClimateReportData = {
  metadata: {
    ...
    weatherSnapshot: {
      ...
      sourceSelections: [
        { parameter: "Temperatur", sourceName: "Oslo - Blindern", sourceId: "SN18700" },
        { parameter: "Relativ luftfuktighet", sourceName: "Oslo - Blindern", sourceId: "SN18700" },
        { parameter: "Nedbør", sourceName: "Oslo - Blindern", sourceId: "SN18700" },
        { parameter: "Vind", sourceName: "Oslo - Blindern", sourceId: "SN18700" },
      ],
      weatherEmoji: "🌦️",
      ...
      minTempC: -1.2,
      avgTempC: 1.1,
      maxRelativeHumidity: 86,
      minRelativeHumidity: 72,
      avgRelativeHumidity: 79.4,
      normalTempC: 0.3,
      precipitationMm: 4.8,
      snowDepthCm: 12,
      avgWindMs: 5.1,
      maxWindMs: 11.6,
      hourly: [
        { date: "2026-02-04", hour: 8, timeLabel: "08:00", temperatureC: -0.4, relativeHumidity: 84, precipitationMm: 0.1, windMs: 3.2, maxWindMs: 5.8, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 9, timeLabel: "09:00", temperatureC: 0.2, relativeHumidity: 86, precipitationMm: 0.0, windMs: 3.5, maxWindMs: 6.3, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 10, timeLabel: "10:00", temperatureC: 0.8, relativeHumidity: 82, precipitationMm: 0.2, windMs: 4.1, maxWindMs: 7.1, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 11, timeLabel: "11:00", temperatureC: 1.3, relativeHumidity: 80, precipitationMm: 0.4, windMs: 4.7, maxWindMs: 8.4, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 12, timeLabel: "12:00", temperatureC: 2.0, relativeHumidity: 78, precipitationMm: 0.6, windMs: 5.0, maxWindMs: 9.2, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 13, timeLabel: "13:00", temperatureC: 2.6, relativeHumidity: 76, precipitationMm: 0.5, windMs: 5.2, maxWindMs: 10.1, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 14, timeLabel: "14:00", temperatureC: 3.1, relativeHumidity: 74, precipitationMm: 0.8, windMs: 5.6, maxWindMs: 11.0, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 15, timeLabel: "15:00", temperatureC: 3.4, relativeHumidity: 72, precipitationMm: 0.9, windMs: 5.8, maxWindMs: 11.6, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 16, timeLabel: "16:00", temperatureC: 2.9, relativeHumidity: 75, precipitationMm: 0.5, windMs: 5.3, maxWindMs: 10.7, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 17, timeLabel: "17:00", temperatureC: 2.1, relativeHumidity: 78, precipitationMm: 0.4, windMs: 4.9, maxWindMs: 9.8, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 18, timeLabel: "18:00", temperatureC: 1.5, relativeHumidity: 80, precipitationMm: 0.2, windMs: 4.5, maxWindMs: 8.6, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 19, timeLabel: "19:00", temperatureC: 0.7, relativeHumidity: 83, precipitationMm: 0.1, windMs: 4.0, maxWindMs: 7.7, snowDepthCm: 12 },
        { date: "2026-02-04", hour: 20, timeLabel: "20:00", temperatureC: 0.1, relativeHumidity: 85, precipitationMm: 0.1, windMs: 3.7, maxWindMs: 6.9, snowDepthCm: 12 },
      ],
    },
